            ...
            <div className="lg:flex justify-between">
              <div className="-mx-6 lg:w-2/6 h-full">
                <div className="px-6">
                  ...
                  <p className="max-w-base mt-2 text-cta-gray">
                    Upload photos of Astrophytum Asterias Nudum to this website
                    for instant identification and price estimation. Perfect for
                  ...
                  <div className="flex mt-6 -mx-2">
                    ...
                    <a
                      href="https://www.facebook.com/gdramixcactus"
                      className="mx-2 text-cta-gray transition-colors duration-300  hover:text-blue-500 dark:hover:text-blue-400"
                      aria-label="Facebook"
                    >
                      <svg
                    ...
                    <a
                      href="https://github.com/BHU23/price_of_astrophytum"
                      className="mx-2 text-cta-gray transition-colors duration-300  hover:text-blue-500 dark:hover:text-blue-400"
                      aria-label="Github"
                    >
                      <svg
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                  <div>
                    <div className="flex text-lg text-cta-text uppercase dark:text-white">
                      <img
                        className="w-auto h-10 pr-2 mb-2"
                        src="https://upload.wikimedia.org/wikipedia/th/7/7b/SUT_LOGO.png"
                      />
                      SURANAREE UNIVERSITY OF TECHNOLOGY
                    </div>

                    <div className="block text-base text-cta-gray ">
                  ...
                  <div className="mr-2">
                    <h3 className="text-gray-700 uppercase dark:text-white mb-5 text-lg">
                      Advisor
                    </h3>
                    <div className="block text-base text-cta-gray">
                    ...
                    <div className="block  text-base text-cta-gray ">
                      {" "}
                      sarunya.k@sut.ac.th , sarunya.k@g.sut.ac.th
                    </div>
                  </div>

                  <div>
                    <h3 className="uppercase text-cta-text mb-5 text-lg">
                      Contact
                    </h3>
                    <div className="grid grid-cols-1 gap-5 sm:grid-cols-1 md:grid-cols-1">
                      <div className="flex flex-col">
                        ...
                        <span className="block text-base text-cta-gray hover:underline">
                          +66 88 476 4656
                        </span>
                        <span className=" text-base text-cta-gray hover:underline">
                          b6403218@g.sut.ac.th
                        </span>
                      </div>
                      <div>
                        <div className="block text-base text-cta-gray">
