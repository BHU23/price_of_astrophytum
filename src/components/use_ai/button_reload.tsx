...
export default function ButtonReload({
  ...
  return (
    <div>
      <input
        className={`block w-full h-10 pr-2 text-sm text-cta-gray border border-border rounded-lg cursor-pointer file:p-2 file:font-semibold file:h-full file:rounded-md file:border-0 file:bg-gray-600 file:text-pear file:text-sm file:mr-2 dark:hover:text-white dark:hover:bg-gray-700 hover:bg-gray-100  dark:focus:ring-gray-700  focus:ring-gray-200 focus:outline-none focus:z-10 focus:ring-4 ${
